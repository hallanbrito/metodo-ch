...
**Engenharia de software humano–IA orientada por decisão, delegação limitada e evidência.**

O **Método Ágil C.H.** é uma proposta experimental para organizar o desenvolvimento de software realizado por equipes híbridas formadas por pessoas e agentes de inteligência artificial.

A sigla preserva duas leituras:

- **ChatGPT–Hallan** — a origem histórica da colaboração que deu início ao método;
- **Colaboração Híbrida** — o princípio geral que permite aplicar o método com diferentes pessoas, modelos e ferramentas.

O método nasceu em 2026 durante a construção incremental do **Maestro Router**, quando o principal gargalo deixou de ser apenas gerar código e passou a ser **decidir, limitar o escopo delegado, verificar resultados e preservar a coerência do produto**.
